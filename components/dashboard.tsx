...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Golden header fixed to the top and full width */}
      <header className="fixed top-0 left-0 right-0 z-50 h-16 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-amber-50 to-amber-100 shadow-sm">
        <div className="container mx-auto h-full px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Wallet className="h-8 w-8 text-amber-500" />
            <h1 className="text-xl font-bold bg-gradient-to-r from-gray-600 to-amber-500 bg-clip-text text-transparent">
              Money Manager
            </h1>
          </div>
          <div className="flex items-center gap-3">
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
                <Button className="gap-2 bg-gradient-to-r from-gray-500 to-amber-400 hover:from-gray-600 hover:to-amber-500 text-white border-0">
      ...
      {/* Main Content — add top padding equal to header height to avoid overlap */}
